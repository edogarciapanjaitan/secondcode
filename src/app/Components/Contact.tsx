...
const Contact = () => {
    return (
        <div className="kontak mt-20 p-10 text-white rounded-2xl" id="contact">
            ...
            <form action="https://formsubmit.co/edson.bennetgarcia@gmail.com" method="POST" className="bg-zinc-800 p-6 sm:p-10 sm:w-fit w-full mx-auto rounded-2xl" autoComplete="off">
